  ...
  test('returns four distinct featured products in priority order', async () => {
    ...
    await Promise.all([
      ...
      OrderModel.create({
        ...
        deliveryWindow: {
          id: 'featured-products-window',
          startsAt: new Date('2026-09-13T05:30:00.000Z'),
          endsAt: new Date('2026-09-13T08:30:00.000Z'),
          countryCode: 'IR',
        ...
        deliveringDateToShipping: new Date('2026-09-13T05:30:00.000Z'),
        shippingPrice: 0,
        shippingInfo: {},
