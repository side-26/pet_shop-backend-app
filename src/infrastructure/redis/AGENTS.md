...
- `otp/redisOtp.store.js` — atomically reserves bounded phone-and-IP OTP keys, replaces owned reservations with hashes, and safely releases failed reservations.
